...
import com.ampznetwork.banmod.api.model.adp.IPropagationAdapter;
...
import static com.ampznetwork.banmod.api.game.Flag.Build;
import static com.ampznetwork.banmod.api.game.Flag.Passthrough;
...
public class EventDispatchBase {
    ...
    public Stream<? extends Region> findRegions(@NotNull Vector.N3 location, @NotNull String worldName) {
        return Stream.concat(
                banMod.getEntityService().findRegions(location, worldName),
